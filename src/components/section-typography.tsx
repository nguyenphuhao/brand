  ...
  return (
    <section id="typography" className="py-24 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <h2 className="text-3xl font-bold text-brand-dark dark:text-brand-light mb-4">
          Plus Jakarta Sans
        </h2>
        <p className="text-brand-dark/60 dark:text-brand-light/50 mb-12 max-w-2xl">
        ...
        <div className="space-y-6 mb-16">
          {typeScale.map((t) => (
            <div key={t.name} className="flex flex-col md:flex-row md:items-baseline gap-2 md:gap-6 border-b border-gray-100 dark:border-white/10 pb-4">
              <div className="w-32 shrink-0">
                <p className="text-xs font-semibold text-brand-primary uppercase tracking-wider">{t.name}</p>
                <p className="text-xs text-brand-dark/40 dark:text-brand-light/30 font-mono">{t.size} / {t.weight}</p>
              </div>
              <p
                style={{
                  fontSize: t.size,
        ...
        <h3 className="text-xl font-bold text-brand-dark dark:text-brand-light mb-4">Vietnamese Diacritics</h3>
        <p className="text-lg text-brand-dark/80 dark:text-brand-light/70 leading-relaxed">
